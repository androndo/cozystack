...
log_substep "Waiting for the restore-target Redis statefulset to be ready..."
kubectl -n "$NAMESPACE" rollout status statefulset/"rfr-${REDIS_RESTORE_NAME}" --timeout=300s
